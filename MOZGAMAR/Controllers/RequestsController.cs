...
namespace MOZGAMAR.Controllers
{
    public class RequestsController : Controller
    {
        ...
        public ActionResult Create(Request request, HttpPostedFileBase fileBase)
        {
            ...
            ViewBag.CategoryId = new SelectList(db.Category, "CategoryId", "Name", request.CategoryId);
            return View(request);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "requestId,Name,Brand,InitialPrice,FinalPrice,Description,CategoryId")] Request request)
        {
            if (ModelState.IsValid)
            {
